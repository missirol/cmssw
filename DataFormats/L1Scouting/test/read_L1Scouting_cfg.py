...
process.l1ScoutingTestAnalyzer = cms.EDAnalyzer("TestReadL1Scouting",
    ...
    caloJetClassVersion = cms.int32(args.caloJetVersion),
    caloJetsTag = cms.InputTag("l1ScoutingTestProducer", "", "PROD"),
    expectedCaloJetFloatingPointValues = cms.vdouble(19., 20., 21.),
    expectedCaloJetIntegralValues = cms.vint32(22, 23, 24)
)
