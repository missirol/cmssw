...
class TestHLS4MLModelB : public l1t::HLS4MLModel {
private:
...
public:
  TestHLS4MLModelB() : inputs_{0, 0, 0}, output_{0} {}

  virtual ~TestHLS4MLModelB() = default;
...
extern "C" l1t::HLS4MLModel* create_model() { return new TestHLS4MLModelB; }
