...
//
math::PtEtaPhiMLorentzVector l1t::CaloTools::p4MP(int const hwPt, int const hwEta, int const hwPhi) {
  return math::PtEtaPhiMLorentzVector(hwPt * 0.5 + 1.E-6, towerEta(hwEta), towerPhi(hwEta, hwPhi), 0.);
}
