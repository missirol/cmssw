...
namespace l1t {
  ...
  public:
    ...
    static int calHwEtSum(int iEta,
                          int iPhi,
    ...
    static size_t calNrTowers(int iEtaMin,
                              int iEtaMax,
                              int iPhiMin,
                              int iPhiMax,
                              const std::vector<l1t::CaloTower>& towers,
    ...
    static math::PtEtaPhiMLorentzVector p4MP(int const, int const, int const);
  ...
  private:
    ...
    static const l1t::CaloTower
        nullTower_;  //to return when we need to return a tower which was not found/invalid rather than throwing an exception
    static const l1t::CaloCluster
        nullCluster_;  //to return when we need to return a cluster which was not found/invalid rather than throwing an exception
