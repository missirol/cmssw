...
#include "PhysicsTools/L1Scouting/interface/Utils.h"

JetMETPerformanceAnalysisDriver::JetMETPerformanceAnalysisDriver(const std::string& tfile, const std::string& ttree, const std::string& outputFilePath, const std::string& outputFileMode)
  : JetMETPerformanceAnalysisDriver(outputFilePath, outputFileMode) {

  setInputTTree(tfile, ttree);
}

JetMETPerformanceAnalysisDriver::JetMETPerformanceAnalysisDriver(const std::string& outputFilePath, const std::string& outputFileMode)
...
bool JetMETPerformanceAnalysisDriver::jetBelongsToCategory(const std::string& categLabel, const float jetPt, const float jetAbsEta) const {
  ...
  else if(categLabel == "_EtaInclPt2"){ ret = (jetAbsEta < 5.0) and (110. <= jetPt) and (jetPt < 200.); }
  else if(categLabel == "_EtaInclPt3"){ ret = (jetAbsEta < 5.0) and (200. <= jetPt) and (jetPt < 400.); }
  else if(categLabel == "_EtaInclPt4"){ ret = (jetAbsEta < 5.0) and (400. <= jetPt) and (jetPt < 1023.4); }
  else if(categLabel == "_EtaInclPt5"){ ret = (jetAbsEta < 5.0) and (1023.4 <= jetPt); }
  ...
  else if(categLabel == "_Eta2p5Pt2"){ ret = (jetAbsEta < 2.5) and (110. <= jetPt) and (jetPt < 200.); }
  else if(categLabel == "_Eta2p5Pt3"){ ret = (jetAbsEta < 2.5) and (200. <= jetPt) and (jetPt < 400.); }
  else if(categLabel == "_Eta2p5Pt4"){ ret = (jetAbsEta < 2.5) and (400. <= jetPt) and (jetPt < 1023.4); }
  else if(categLabel == "_Eta2p5Pt5"){ ret = (jetAbsEta < 2.5) and (1023.4 <= jetPt); }
  ...
  else if(categLabel == "_HBPt2"){ ret = (jetAbsEta < 1.3) and (110. <= jetPt) and (jetPt < 200.); }
  else if(categLabel == "_HBPt3"){ ret = (jetAbsEta < 1.3) and (200. <= jetPt) and (jetPt < 400.); }
  else if(categLabel == "_HBPt4"){ ret = (jetAbsEta < 1.3) and (400. <= jetPt) and (jetPt < 1023.4); }
  else if(categLabel == "_HBPt5"){ ret = (jetAbsEta < 1.3) and (1023.4 <= jetPt); }
  ...
  else if(categLabel == "_HEPt2"){ ret = (1.3 <= jetAbsEta) and (jetAbsEta < 3.0) and (110. <= jetPt) and (jetPt < 200.); }
  else if(categLabel == "_HEPt3"){ ret = (1.3 <= jetAbsEta) and (jetAbsEta < 3.0) and (200. <= jetPt) and (jetPt < 400.); }
  else if(categLabel == "_HEPt4"){ ret = (1.3 <= jetAbsEta) and (jetAbsEta < 3.0) and (400. <= jetPt) and (jetPt < 1023.4); }
  else if(categLabel == "_HEPt5"){ ret = (1.3 <= jetAbsEta) and (jetAbsEta < 3.0) and (1023.4 <= jetPt); }
  ...
  else if(categLabel == "_HFPt2"){ ret = (3.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (110. <= jetPt) and (jetPt < 200.); }
  else if(categLabel == "_HFPt3"){ ret = (3.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (200. <= jetPt) and (jetPt < 400.); }
  else if(categLabel == "_HFPt4"){ ret = (3.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (400. <= jetPt) and (jetPt < 1023.4); }
  else if(categLabel == "_HFPt5"){ ret = (3.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (1023.4 <= jetPt); }
...
//  }
  ...
  // Single-Jet
  for (auto const& jetLabel : labelMap_jetAK4_) {
    auto const jetPt1 = (jetLabel.first == "GenJet") ? minAK4JetPtRef : minAK4JetPt;
    ...
    for (auto const& jetLabelRefs : jetLabel.second) {
      auto const jetPt2 = (jetLabelRefs.second == "GenJet") ? minAK4JetPtRef : minAK4JetPt;
...
void JetMETPerformanceAnalysisDriver::bookHistograms_Jets(const std::string& dir, const std::string& jetType, const std::vector<std::string>& matchLabels){
  ...
  for(uint idx=0; idx<binEdges_minDeltaR.size(); ++idx){ binEdges_minDeltaR.at(idx) = 0.05*idx; }
  ...
  for(uint idx=0; idx<binEdges_nPU.size(); ++idx){ binEdges_nPU.at(idx) = 3*idx; }
...
//    addTH1D(dirPrefix+jetType+catLabel+"_muonMultiplicity", binEdges_dauMult2);
    ...
    for(auto const& matchLabel : matchLabels){
      ...
      addTH2D(dirPrefix+jetType+catLabel+"_pt__vs__"+matchLabel+"_minDeltaR", binEdges_pt, binEdges_minDeltaR);
      ...
      addTH2D(dirPrefix+jetType+catLabel+"_pt0__vs__"+matchLabel+"_minDeltaR", binEdges_pt, binEdges_minDeltaR);
      addTH2D(dirPrefix+jetType+catLabel+"_eta__vs__"+matchLabel+"_minDeltaR", binEdges_eta, binEdges_minDeltaR);
...
//      addTH1D(dirPrefix+jetType+catLabel+"_MatchedTo"+matchLabel+"_muonMultiplicity", binEdges_dauMult2);
      ...
      addTH2D(dirPrefix+jetType+catLabel+"_MatchedTo"+matchLabel+"_pt_over"+matchLabel+"__vs__"+matchLabel+"_nPU", binEdges_response, binEdges_nPU);
      ...
      addTH2D(dirPrefix+jetType+catLabel+"_MatchedTo"+matchLabel+"_pt0_over"+matchLabel+"__vs__"+matchLabel+"_nPU", binEdges_response, binEdges_nPU);
      ...
      addTH2D(dirPrefix+jetType+catLabel+"_MatchedTo"+matchLabel+"_mass_over"+matchLabel+"__vs__"+matchLabel+"_nPU", binEdges_response, binEdges_nPU);
...
void JetMETPerformanceAnalysisDriver::fillHistograms_Jets(const std::string& dir, const fillHistoDataJets& fhData, float const weight){
...
//  auto const* v_muonEnergyFraction(this->vector_ptr<float>(fhData.jetCollection+"_muonEnergyFraction"));
  ...
  for(auto const& catLabel : jetCategoryLabels_){
    ...
    float jetPtMax(-1.);
    for(auto idx=0; idx<v_pt_size; ++idx){
      if(v_pt[idx] <= fhData.jetPtMin or std::abs(v_eta[idx]) >= fhData.jetAbsEtaMax){ continue; }
...
//
//      for(auto idx=0; idx<v_pt_size; ++idx){
//        if(v_pt[idx] <= fhData.jetPtMin){ continue; }
//
//        for(auto const& catLabel : jetCategoryLabels_){
//
//          if(jetBelongsToCategory(catLabel, v_pt[idx], std::abs(v_eta[idx])))
...
//    }
    ...
    for(auto const& catLabel : jetCategoryLabels_){
      ...
      for(auto idx=0; idx<v_match_pt_size; ++idx){
        if(v_match_pt[idx] <= fhData.jetPtMin or std::abs(v_match_eta[idx]) >= fhData.jetAbsEtaMax){ continue; }
      ...
      H2(dirPrefix+fhData.jetCollection+catLabel+"_HT__vs__"+matchLabel+"_HT")->Fill(sumPt, sumMatchRefPt, weight);
      H2(dirPrefix+fhData.jetCollection+catLabel+"_MHT__vs__"+matchLabel+"_MHT")->Fill(sqrt(sumPx*sumPx + sumPy*sumPy), sqrt(sumMatchRefPx*sumMatchRefPx + sumMatchRefPy*sumMatchRefPy), weight);
      ...
      for(auto const jetIdx : jetIndices){
	    ...
	    maxPtJetPtWithMatch = jetPt;
          ...
          H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_eta__vs__pt")->Fill(jetEta, jetPt, weight);
...
//          if(v_muonEnergyFraction         ){ H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_muonEnergyFraction"         )->Fill(v_muonEnergyFraction->at(jetIdx), weight); }
          ...
          H2(dirPrefix+fhData.jetCollection+catLabel+"_pt__vs__"+matchLabel+"_pt")->Fill(jetPt, jetMatchPt, weight);
          H2(dirPrefix+fhData.jetCollection+catLabel+"_pt__vs__"+matchLabel+"_eta")->Fill(jetPt, jetMatchEta, weight);
          H2(dirPrefix+fhData.jetCollection+catLabel+"_pt__vs__"+matchLabel+"_minDeltaR")->Fill(jetPt, minDeltaR, weight);

          if(indexCounter == 0){
            H2(dirPrefix+fhData.jetCollection+catLabel+"_pt0__vs__"+matchLabel+"_pt")->Fill(jetPt, jetMatchPt, weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_pt0__vs__"+matchLabel+"_eta")->Fill(jetPt, jetMatchEta, weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_pt0__vs__"+matchLabel+"_minDeltaR")->Fill(jetPt, minDeltaR, weight);
          }

          H2(dirPrefix+fhData.jetCollection+catLabel+"_eta__vs__"+matchLabel+"_minDeltaR")->Fill(jetEta, minDeltaR, weight);

          H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt__vs__"+matchLabel+"_pt")->Fill(jetPt, jetMatchPt, weight);
          H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_eta__vs__"+matchLabel+"_eta")->Fill(jetEta, jetMatchEta, weight);

          auto const dR2match(utils::deltaR2(jetEta, jetPhi, jetMatchEta, jetMatchPhi));
          H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_dRmatch")->Fill(sqrt(dR2match), weight);

          if(jetMatchPt != 0.){
            auto const jetPtRatio(jetPt / jetMatchPt);
            H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt_over"+matchLabel)->Fill(jetPtRatio, weight);
            ...
            H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt_over"+matchLabel+"__vs__"+matchLabel+"_eta")->Fill(jetPtRatio, jetMatchEta, weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt_over"+matchLabel+"__vs__"+matchLabel+"_nPU")->Fill(jetPtRatio, nPU, weight);
          }

          if(jetMatchMass != 0.){
            auto const jetMassRatio(jetMass / jetMatchMass);
            H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_mass_over"+matchLabel)->Fill(jetMassRatio, weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_mass_over"+matchLabel+"__vs__"+matchLabel+"_pt")->Fill(jetMassRatio, jetMatchPt, weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_mass_over"+matchLabel+"__vs__"+matchLabel+"_eta")->Fill(jetMassRatio, jetMatchEta, weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_mass_over"+matchLabel+"__vs__"+matchLabel+"_mass")->Fill(jetMassRatio, jetMatchMass, weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_mass_over"+matchLabel+"__vs__"+matchLabel+"_nPU")->Fill(jetMassRatio, nPU, weight);
          }
        }
        else {
	    ...
	    maxPtJetPtWithNoMatch = jetPt;
          ...
          if(indexCounter == 0){
            H2(dirPrefix+fhData.jetCollection+catLabel+"_pt0__vs__"+matchLabel+"_pt")->Fill(jetPt, -1., weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_pt0__vs__"+matchLabel+"_eta")->Fill(jetPt, -99., weight);
            H2(dirPrefix+fhData.jetCollection+catLabel+"_pt0__vs__"+matchLabel+"_minDeltaR")->Fill(jetPt, minDeltaR, weight);
          }
          ...
          H2(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_eta__vs__pt")->Fill(jetEta, jetPt, weight);
          H1(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_phi")->Fill(jetPhi, weight);
          H1(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_mass")->Fill(jetMass, weight);
...
//          if(v_muonEnergyFraction         ){ H1(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_muonEnergyFraction"         )->Fill(v_muonEnergyFraction         ->at(jetIdx), weight); }
      ...
      H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_njets")->Fill(0.01 + nJetsMatched, weight);
      H1(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_njets")->Fill(0.01 + nJetsNotMatched, weight);

      H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_HT")->Fill(sumPtMatched, weight);
      H1(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_HT")->Fill(sumPtNotMatched, weight);

      H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_MHT")->Fill(sqrt(sumPxMatched*sumPxMatched + sumPyMatched*sumPyMatched), weight);
      H1(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_MHT")->Fill(sqrt(sumPxNotMatched*sumPxNotMatched + sumPyNotMatched*sumPyNotMatched), weight);

      if(indexMaxPtJetWithMatch >= 0){
        auto const maxPtJetPt(v_pt[indexMaxPtJetWithMatch]);
        auto const maxPtJetMatchPt(v_match_pt[mapMatchIndeces.at(indexMaxPtJetWithMatch)]);
        auto const maxPtJetMatchEta(v_match_eta[mapMatchIndeces.at(indexMaxPtJetWithMatch)]);
        H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt0")->Fill(maxPtJetPt, weight);
        H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt0__vs__"+matchLabel+"_pt")->Fill(maxPtJetPt, maxPtJetMatchPt, weight);
        H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt0__vs__"+matchLabel+"_eta")->Fill(maxPtJetPt, maxPtJetMatchEta, weight);
        if(maxPtJetMatchPt != 0.){
          auto const maxPtJetPtRatio(maxPtJetPt / maxPtJetMatchPt);
          H1(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt0_over"+matchLabel)->Fill(maxPtJetPtRatio, weight);
          H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt0_over"+matchLabel+"__vs__"+matchLabel+"_pt")->Fill(maxPtJetPtRatio, maxPtJetMatchPt, weight);
          H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt0_over"+matchLabel+"__vs__"+matchLabel+"_eta")->Fill(maxPtJetPtRatio, maxPtJetMatchEta, weight);
          H2(dirPrefix+fhData.jetCollection+catLabel+"_MatchedTo"+matchLabel+"_pt0_over"+matchLabel+"__vs__"+matchLabel+"_nPU")->Fill(maxPtJetPtRatio, nPU, weight);
        }
      }

      if(indexMaxPtJetWithNoMatch >= 0){
        auto const maxPtJetPt(v_pt[indexMaxPtJetWithNoMatch]);
        H1(dirPrefix+fhData.jetCollection+catLabel+"_NotMatchedTo"+matchLabel+"_pt0")->Fill(maxPtJetPt, weight);
      }
    }
  }
}

void JetMETPerformanceAnalysisDriver::bookHistograms_MET(const std::string& dir, const std::string& metType, const std::vector<std::string>& matchLabels){
...
void JetMETPerformanceAnalysisDriver::bookHistograms_Jets_2DMaps(const std::string& dir, const std::string& jetType1, const std::string& jetType2){
...
void JetMETPerformanceAnalysisDriver::fillHistograms_Jets_2DMaps(const std::string& dir, const fillHistoDataJets& fhData1, const fillHistoDataJets& fhData2, float const weight){
...
void JetMETPerformanceAnalysisDriver::bookHistograms_MET_2DMaps(const std::string& dir, const std::string& metType1, const std::string& metType2, bool const book1D){
...
void JetMETPerformanceAnalysisDriver::fillHistograms_MET_2DMaps(const std::string& dir, const fillHistoDataMET& fhData1, const fillHistoDataMET& fhData2, bool const fill1D, float const weight){
