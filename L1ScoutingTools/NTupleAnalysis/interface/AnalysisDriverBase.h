#ifndef PhysicsTools_L1Scouting_AnalysisDriverBase_h
#define PhysicsTools_L1Scouting_AnalysisDriverBase_h
...
class AnalysisDriverBase {
 ...
 public:
  ...
  template<class T> TTreeReaderArray<T> const& array(const std::string& key) const;
