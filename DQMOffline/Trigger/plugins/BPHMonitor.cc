...
double BPHMonitor::Prescale(const std::string hltpath1,
  ...
  auto const prescales_den = hltPrescale_->prescaleValuesInDetail<double, int>(iEvent, iSetup, hltpath);
  auto const prescales_num = hltPrescale_->prescaleValuesInDetail<double, int>(iEvent, iSetup, hltpath1);
