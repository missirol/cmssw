...
{
  LogDebug("HLTDoublet") << "InputTags and cuts : inputTag1=" << inputTag1_.encode()
                         << " inputTag2=" << inputTag2_.encode() << " triggerType1=" << triggerType1_
                         << " triggerType2=" << triggerType2_ << " Deta [" << min_Deta_ << ", " << max_Deta_ << "]"
                         ...
                         << " minv=" << cutminv_ << " delr2=" << cutdelr2_ << " pt=" << cutpt_;
}
