# hltGetConfiguration --dbproxy --full --data /dev/CMSSW_12_4_0/PIon --type PIon --unprescale --process HLTPIon --globaltag auto:run3_hlt_PIon --input file:RelVal_Raw_PIon_DATA.root

# /dev/CMSSW_12_4_0/PIon/V180 (CMSSW_12_4_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_12_4_0/PIon/V180')
)
