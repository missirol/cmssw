# hltGetConfiguration v3-test/run3:/dev/CMSSW_13_3_0/Fake --full --data --type Fake --unprescale --process HLTFake --globaltag auto:run1_hlt_Fake --input file:RelVal_Raw_Fake_DATA.root

# /dev/CMSSW_13_3_0/Fake/V6 (CMSSW_13_3_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string("/dev/CMSSW_13_3_0/Fake/V6")
)
