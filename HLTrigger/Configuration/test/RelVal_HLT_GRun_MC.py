...
# with command line options: RelVal --step=HLT:GRun --conditions=auto:run3_mc_GRun --filein=/store/relval/CMSSW_12_3_0_pre3/RelValTTbar_14TeV/GEN-SIM-DIGI-RAW/123X_mcRun3_2021_realistic_v3-v1/10000/635c70bf-874f-4e3d-926d-11d06ffff564.root --custom_conditions= --fileout=RelVal_HLT_GRun_MC.root --number=100 --mc --no_exec --datatier SIM-DIGI-RAW-HLTDEBUG --eventcontent=FEVTDEBUGHLT --customise=HLTrigger/Configuration/CustomConfigs.L1THLT --era=Run3 --customise= --scenario=pp --python_filename=RelVal_HLT_GRun_MC.py --processName=HLT
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/relval/CMSSW_12_3_0_pre3/RelValTTbar_14TeV/GEN-SIM-DIGI-RAW/123X_mcRun3_2021_realistic_v3-v1/10000/635c70bf-874f-4e3d-926d-11d06ffff564.root'),
