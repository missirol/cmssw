...
MASTER="/users/missirol/test/dev/CMSSW_12_4_0/CMSHLT_2523/Test01/HLT"             # no explicit version, take the most recent
TARGET="/users/missirol/test/dev/CMSSW_12_4_0/CMSHLT_2523/Test01/\$TABLE"         # no explicit version, take the most recent
