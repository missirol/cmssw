...
def customiseForOffline(process):
    ...
    #  - added manually here for illustration
    #  - this module will actually be added to the menus in ConfDB
    ...
    # For running HLT offline on Run-3 data, use
    # "(BeamSpotOnlineProducer).useTransientRecord=true" and "(OnlineBeamSpotESProducer).timeThreshold = 1e6",
    # in order to pick the beamspot that was actually used by the HLT (instead of a "fake" beamspot).
    # These same settings can be used for MC.
    # See CMSHLT-2271 and CMSHLT-2300 for further details.
