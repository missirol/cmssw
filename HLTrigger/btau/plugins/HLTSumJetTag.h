...
private:
  float findTagValueByMinDeltaR2(T const& jet, reco::JetTagCollection const& jetTags, float maxDeltaR2) const;
  ...
  const int m_MinJetToSum;     // min number of jets to be considered in the mean
  const int m_MaxJetToSum;     // max number of jets to be considered in the mean
