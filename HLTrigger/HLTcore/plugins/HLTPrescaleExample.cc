...
void HLTPrescaleExample::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup) {
  ...
  auto l1HLTPSInt = hltPSProvider_.prescaleValues<double, int>(iEvent, iSetup, hltPath_);
  ...
  log << "---------Begin Event--------"
      << "\n";
  log << "hltDouble " << hltPSDouble << " hltInt " << hltPSInt << " hltPSUInt " << hltPSUInt << " hltFrac " << hltPSFrac
      << "\n";

  log << " l1HLTDouble " << l1HLTPSDouble.first << " " << l1HLTPSDouble.second << " l1HLTInt " << l1HLTPSInt.first
      << " " << l1HLTPSInt.second << " l1HLTFrac " << l1HLTPSFrac.first << " " << l1HLTPSFrac.second
      << " l1HLTDoubleFrac " << l1HLTPSDoubleFrac.first << " " << l1HLTPSDoubleFrac.second << "\n";
  ...
  printL1HLTDetail("l1HLTDetailInt ", l1HLTDetailPSInt);
