...
void HLTEventAnalyzerAOD::analyzeTrigger(const edm::Event& iEvent,
  ...
  auto const prescales = hltPrescaleProvider_.prescaleValues<double, int>(iEvent, iSetup, triggerName);
  ...
  auto const prescalesInDetail = hltPrescaleProvider_.prescaleValuesInDetail<double, int>(iEvent, iSetup, triggerName);
