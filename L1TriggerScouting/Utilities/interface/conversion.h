...
namespace l1ScoutingRun3 {
  ...
  namespace calol1 {
    ...
    static constexpr int16_t kHwEtaAbsMin = 1;
    static constexpr int16_t kHwEtaAbsMax = 41;
    static constexpr int16_t kHwEtaAbsHFFirst = 29;

    bool validHwEta(int16_t hwEta);
    float fEta(int16_t hwEta);

    static constexpr int16_t kHwPhiMin = 1;
    static constexpr int16_t kHwPhiMax = 72;
