...
void L1ScoutingCaloTowerPhysicalValueMapProducer::produce(edm::StreamID,
  ...
  for (auto iobj = 0; iobj < nobjs; ++iobj) {
    ...
    auto const mpEta = l1t::CaloTools::mpEta(obj.hwEta());
    outv_fEta.emplace_back(l1t::CaloTools::towerEta(mpEta));
    outv_fPhi.emplace_back(l1t::CaloTools::towerPhi(mpEta, obj.hwPhi()));
  }
